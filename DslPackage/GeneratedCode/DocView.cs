...
namespace FourDeep.Dizzle
{
	...
	/// </summary>
	internal partial class DizzleDocView : DizzleDocViewBase
	{
		/// <summary>
		/// Constructs a new DizzleDocView.
		/// </summary>
		public DizzleDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DizzleDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new DizzleDocView.
		/// </summary>
		protected DizzleDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			DizzleDocDataBase docData = this.DocData as DizzleDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for DizzleDocViewBase should be an DizzleDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::FourDeep.Dizzle.DizzleDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::FourDeep.Dizzle.DizzleDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::FourDeep.Dizzle.DizzleToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::FourDeep.Dizzle.DizzleToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.DizzleDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::FourDeep.Dizzle.DizzleHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::FourDeep.Dizzle.DizzleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::FourDeep.Dizzle.DizzleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
