...
namespace FourDeep.Dizzle
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.DizzleEditorFactoryId)]
	internal partial class DizzleEditorFactory : DizzleEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new DizzleEditorFactory.
		/// </summary>
		public DizzleEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class DizzleEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected DizzleEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new DizzleDocData(this.ServiceProvider, typeof(DizzleEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new DizzleDocView(docData, this.ServiceProvider);
		}
	}
}
