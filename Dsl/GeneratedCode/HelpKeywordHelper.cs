...
namespace FourDeep.Dizzle
{
	...
	/// </remarks>
	public partial class DizzleHelpKeywordHelper : DizzleHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new DizzleHelpKeywordHelper.
		/// </summary>
		protected DizzleHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the DizzleHelpKeywordHelper.
		/// </summary>
		public static DizzleHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class DizzleHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new DizzleHelpKeywordHelperBase.
		/// </summary>
		protected DizzleHelpKeywordHelperBase()
			: base() { }
